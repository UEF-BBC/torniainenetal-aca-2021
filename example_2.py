# This is the source code for example 2 of the manuscript. Dataset not included.
#
# jtorniainen // UEF
# 2021
# MIT License
...
if __name__ == '__main__':
    ...
    # Dataset can be retrieved from https://www.kaggle.com/fkosmowski/crop-varietal-identification-with-scio
    ...
    y = df["Predictor"].to_numpy()
    x = df.drop("Predictor", axis=1).to_numpy()
    w = np.asarray([int(val) for val in df.drop("Predictor", axis=1).columns])
